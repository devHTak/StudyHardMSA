...
class ZoneControllerTest {
    ...
    void saveTagSuccessTest() throws Exception {
        ...
        Zone zone = zoneRepository.findByAddressCityAndAddressLocalNameCityAndAddressProvince(address.getCity(), address.getLocalNameCity(), address.getProvince())
    ...
    void existByTagNameSuccessTest() throws Exception {
        Address address = new Address("Test1", "Test2", "Test3");
        boolean result = zoneRepository.existsByAddressCityAndAddressLocalNameCityAndAddressProvince(address.getCity(), address.getLocalNameCity(), address.getProvince());
        assertThat(result).isTrue();

        mockMvc.perform(get("/tag-zone-service/zones/find")
